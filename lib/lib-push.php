...
class pushmessage{ 
	...
	public $androidAuthKey		= "AIzaSyDHalT2fve-8CWMj_yN5PQvbmASfYl9gIo"; 
...
//        $this->androidAuthKey = "Android Auth Key Here";//Auth Key Herer 
     ...
     */ 
    public function send($mobiles,$params){ 
        //$sql    = "select pushtype, idphone from gcmapns "; 
       // $rows    = $CI->db->get_rows($sql); 
       //get data from database and save to $rows 
//        $mobiles = array(
//            array("pushtype"=>"android","idphone"=>"APA91bGM4S04L31EhEl0x6Xb0125Wtu6ZPTpFWA-x-wUj34BSMH4c2_gBVs4UMZjfuIMHWvGmbOy6XBvPo3oVMIREGmPOUSEwhjNMZNiNcz7TiLIKzJ9kLXR-QYkmWmLSD4PyaMQAC_c")
//        );
        if(is_array($mobiles)){ 
